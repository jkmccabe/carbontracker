...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'rounded-md font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 inline-flex items-center justify-center';
  ...
  const variantStyles = {
    ...
    link: 'bg-transparent underline text-primary-600 hover:text-primary-700 p-0 h-auto focus:ring-0'
  };
